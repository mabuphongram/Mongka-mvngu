...
class Year2017 extends StatefulWidget {
  const Year2017({Key key}) : super(key: key);

  @override
  State<Year2017> createState() => _Year2017State();
}

class _Year2017State extends State<Year2017> {
  ...
  Future<void> playMusic() async {
    final bytes = await rootBundle.load("assets/audio/year2017_1.mp3");
  ...
  void initState() {
    ...
    audioPlayer.onPlayerCompletion.listen((event) async {
      ...
      final bytes =
          await rootBundle.load("assets/audio/year2017_${counter + 1}.mp3");
      await audioPlayer.playBytes(bytes.buffer.asUint8List());
      counter++;
    });
  }
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          // elevation: 0,
          title: Text(
            "2017 Nǿng Zilàngré Zaywarì",
            style:  TextStyle(fontFamily: 'text1', fontSize: 22),
          ),
        ),
        body: Column(
          children: [
                ...
                IconButton(
                    onPressed: () async {
                      final fileBytes = await rootBundle
                          .load("assets/audio/year2017_$counter.mp3");
                      final tempDir = await getTemporaryDirectory();
                      final tempFile = await File(
                              '${tempDir.path}/${"year2017_$counter.mp3"}')
                          .create();
                ...
                IconButton(
                  onPressed: () async {
                    ...
                    final bytes = await rootBundle
                        .load("assets/audio/year2017_${counter - 1}.mp3");
                    await audioPlayer.playBytes(bytes.buffer.asUint8List());
                    counter--;
                  },
